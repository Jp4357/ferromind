...
export default function LoginForm({ onSuccess }: { onSuccess: () => void }) {
  ...
  return (
    <div style={{
      ...
      {/* Corner marks */}
      {[
        { top: 24, left: 24, borderTop: "1px solid rgba(240,165,0,0.2)", borderLeft: "1px solid rgba(240,165,0,0.2)" },
        { top: 24, right: 24, borderTop: "1px solid rgba(240,165,0,0.2)", borderRight: "1px solid rgba(240,165,0,0.2)" },
        { bottom: 24, left: 24, borderBottom: "1px solid rgba(240,165,0,0.2)", borderLeft: "1px solid rgba(240,165,0,0.2)" },
        { bottom: 24, right: 24, borderBottom: "1px solid rgba(240,165,0,0.2)", borderRight: "1px solid rgba(240,165,0,0.2)" },
      ].map((pos, i) => (
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: 30 }}>
          ...
          <h1 style={{ fontFamily: "Syne, sans-serif", fontSize: 24, fontWeight: 700, color: "#e8ecf0", letterSpacing: "-0.4px", marginBottom: 6 }}>
            FerroMind
          </h1>
          <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 10, color: "#6b7a8d", letterSpacing: "0.14em", textTransform: "uppercase" }}>
        ...
        <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 11, color: "#6b7a8d", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 20 }}>
          Sign in to continue
        </p>
        ...
        <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          {/* Username */}
          <div>
            <label style={{ display: "block", fontFamily: "'DM Mono', monospace", fontSize: 10, color: "#6b7a8d", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 7 }}>
              Username
            </label>
            <input
              ...
              style={{
                ...
                borderRadius: 8, color: "#e8ecf0",
                fontFamily: "'DM Mono', monospace", fontSize: 13, outline: "none",
                transition: "border-color 0.18s, box-shadow 0.18s",
              }}
              onFocus={e => { e.target.style.borderColor = "rgba(240,165,0,0.5)"; e.target.style.boxShadow = "0 0 0 3px rgba(240,165,0,0.08)"; }}
              onBlur={e  => { e.target.style.borderColor = error ? "rgba(232,82,74,0.4)" : "rgba(255,255,255,0.09)"; e.target.style.boxShadow = "none"; }}
            />
          </div>
          ...
          {error && (
            <div style={{
              background: "rgba(232,82,74,0.07)", border: "1px solid rgba(232,82,74,0.22)",
              borderRadius: 6, padding: "9px 12px",
              fontFamily: "'DM Mono', monospace", fontSize: 11, color: "#e8524a",
          ...
          <button type="submit" disabled={loading} style={{
            ...
            background: loading ? "rgba(240,165,0,0.1)" : "linear-gradient(135deg, rgba(240,165,0,0.92), rgba(224,92,42,0.88))",
        ...
        <div style={{
          ...
          <span style={{ fontFamily: "'DM Mono', monospace", fontSize: 10, color: "rgba(107,122,141,0.45)" }}>Secure access</span>
          <span style={{ fontFamily: "'DM Mono', monospace", fontSize: 10, color: "rgba(107,122,141,0.45)" }}>FerroMind v2.0</span>
        </div>
      </div>
